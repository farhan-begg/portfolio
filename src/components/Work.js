...
const Work = () => {
  return <section className="section min-h-[85vh] lg:max-h-[90vh]" id="work">
        ...
        <motion.div variants={fadeIn("right", 0.3)}
          ...
          <div>
            ...
            <p className='max-w-sm mb-16'>
              lorem Ipsum ipsum about aboutnadf   adfknalkfjalkd  adfjlakdfj
              alflaq0iehvn  alskncou s laiealns alskdjh har quis
            </p>
          ...
          <div className="group relative overflow-hidden border-2 border-white/50 rounded-1px]">
            ...
            <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50 flex gap-x-[10px]  ">
              <span className="text-3x1 text-white">My Life</span>
              <h4>Live</h4>
              <h4>Code</h4>
